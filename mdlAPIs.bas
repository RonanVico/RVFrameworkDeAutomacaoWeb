...
#If VBA7 Then
  ...
  Public Declare PtrSafe Function FindWindowExA Lib "user32.dll" (ByVal hwndParent As LongPtr, ByVal hwndChildAfter As LongPtr, ByVal lpszClass As String, ByVal lpszWindow As String) As LongPtr
  Public Declare PtrSafe Function PostMessageA Lib "user32.dll" (ByVal hwnd As LongPtr, ByVal wMsg As LongPtr, ByVal wParam As LongPtr, ByVal lParama As LongPtr) As LongPtr
  ...
  Public Declare PtrSafe Function GetClassName Lib "user32" Alias "GetClassNameA" (ByVal hwnd As LongPtr, ByVal lpClassName As String, ByVal nMaxCount As LongPtr) As LongPtr
  Public Declare PtrSafe Function GetWindow Lib "user32" (ByVal hwnd As LongPtr, ByVal wCmd As LongPtr) As LongPtr
  Public Declare PtrSafe Function GetWindowLongA Lib "user32.dll" (ByVal hwnd As LongPtr, ByVal nIndex As Integer) As LongPtr
  Public Declare PtrSafe Function SetForegroundWindow Lib "user32" (ByVal hwnd As LongPtr) As LongPtr
  Public Declare PtrSafe Function SendMessageByString Lib "user32.dll" Alias "SendMessageA" (ByVal hwnd As LongPtr, ByVal wMsg As LongPtr, ByVal wParam As LongPtr, ByVal lParam As String) As LongPtr
  'Mouse APIS \/
